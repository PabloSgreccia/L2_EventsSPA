...
const { showAll, showEvent, createEvent, updateEvent, destroyEvent, showAllAdmin, eventscreatedbyuser, eventsfollowedbyuser } = require('../contrtoller/event.controller');
